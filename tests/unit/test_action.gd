...
func test_basic_payload():
	...
	assert_true(payload is Action.Payload, "Should be instance of Action.Payload")

func test_pay_lv_compl_payload():
	# Test PayLvCompl payload
	var payload = Action.PayLvCompl.new(Level.IDs.Level1)
...
func test_pay_enem_killed_payload():
	...
	var killed_count = 5
	var payload = Action.PayEnemKilled.new(killed_count)
...
func test_pay_lvl_compl_all_canons_payload():
	...
	var canons_alive = 3
	var payload = Action.PayLvlComplAllCanons.new(Level.IDs.Level2, canons_alive)
...
func test_pay_buyed_ally_level_payload():
	...
	var payload = Action.PayBuyedAllyLevel.new(ally_level_id, Ally.IDs.CHEST)
...
func test_action_with_level_completion_payload():
	...
	assert_true(action.payload is Action.PayLvCompl, "Payload should be correct type")
...
func test_action_with_enemy_killed_payload():
	...
	var payload = Action.PayEnemKilled.new(enemies_killed)
	...
	assert_true(action.payload is Action.PayEnemKilled, "Payload should be correct type")
