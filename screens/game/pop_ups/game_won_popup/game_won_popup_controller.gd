## Controller that manages input handling for the game won popup
## Handles keyboard, gamepad and touch interactions for navigation and button selection
class_name GameWonPopupController extends InputController

## Handles input events for the game won popup
## Parameters:
...
## Processes key press input events for popup navigation
## Parameters:
