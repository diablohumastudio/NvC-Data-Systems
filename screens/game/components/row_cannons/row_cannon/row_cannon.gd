...
const _CANNON_BULLET_PKSC: PackedScene = preload("uid://oq6aen6b7qdb")
...
func _physics_process(_delta):
	if is_active and animation_player.current_animation == "_shoot":
...
func _start_bullet_movement_animation():
	var cannon_bullet_scene : PackedScene = _CANNON_BULLET_PKSC
