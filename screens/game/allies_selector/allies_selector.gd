...
func _ready() -> void:
	populate_cards()
	ally_selector_button_group.pressed.connect(on_ally_selector_button_group_changed)
...
func on_ally_selector_button_group_changed(ally_sel_card_btn: TextureButton):
